...
export const BLOODLINES = {
    ...
    LINH: { name: LINH_THU_QUALITIES.LINH_CAP, color: '#4fd1c5', multiplier: 1.5 },
    DIA: { name: LINH_THU_QUALITIES.DIA_CAP, color: '#a855f7', multiplier: 2.5 },
    THIEN: { name: LINH_THU_QUALITIES.THIEN_CAP, color: '#f59e0b', multiplier: 5.0 },
    THANH: { name: LINH_THU_QUALITIES.THANH_HUYET, color: '#ec4899', multiplier: 10.0 },
    TIEN: { name: LINH_THU_QUALITIES.TIEN_HUYET, color: '#3b82f6', multiplier: 25.0 },
    THAN: { name: LINH_THU_QUALITIES.THAN_HUYET, color: '#facc15', multiplier: 100.0 }
};
...
export const BEASTS = {
    ...
    'thanh_long': {
        ...
        name: 'Thanh Long',
        type: BEAST_TYPES.THAN_THU,
        bloodline: BEAST_BLOODLINES.THAN,
        icon: '🐉',
    ...
    'ngoc_long': {
        ...
        name: 'Ngọc Long',
        type: BEAST_TYPES.THAN_THU,
        bloodline: BEAST_BLOODLINES.TIEN,
        icon: '🐉',
