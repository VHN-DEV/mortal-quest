...
export const ASSETS = {
    ...
    techniques: createAssetProxy({
        truong_xuan_nap_khi_quyet: getAssetUrl('items/techniques/truong_xuan_nap_khi_quyet'),
        liet_duong_cong: getAssetUrl('items/techniques/liet_duong_cong'),
        han_thuy_quyet: getAssetUrl('items/techniques/han_thuy_quyet'),
        thanh_moc_tam_kinh: getAssetUrl('items/techniques/thanh_moc_tam_kinh'),
        canh_kim_quyet: getAssetUrl('items/techniques/canh_kim_quyet'),
        ...
        truong_sinh_quyet_bi_tich: getAssetUrl('items/techniques/truong_sinh_quyet'),
        ...
        huyen_thuy_nap_linh_quyet: getAssetUrl('items/techniques/huyen_thuy_nap_linh_quyet'),
        tu_duong_chan_khi: getAssetUrl('items/techniques/tu_duong_chan_khi'),
        phong_loi_quyet: getAssetUrl('items/techniques/phong_loi_quyet'),
        thanh_nguyen_kiem_quyet: getAssetUrl('items/techniques/thanh_nguyen_kiem_quyet'),
        dai_dien_quyet: getAssetUrl('items/techniques/dai_dien_quyet'),
        minh_vuong_quyet: getAssetUrl('items/techniques/minh_vuong_quyet'),
        phe_huyet_ma_cong: getAssetUrl('items/techniques/phe_huyet_ma_cong'),
        van_doc_hoa_cot_quyet: getAssetUrl('items/techniques/van_doc_hoa_cot_quyet'),
        hu_thien_tran_phap_quyen: getAssetUrl('items/techniques/hu_thien_tran_phap_quyen'),
        hoang_phong_coc_cong_phap: getAssetUrl('items/techniques/hoang_phong_coc_cong_phap'),
        thien_tinh_tong_cong_phap: getAssetUrl('items/techniques/thien_tinh_tong_cong_phap'),
        linh_thu_son_cong_phap: getAssetUrl('items/techniques/linh_thu_son_cong_phap'),
        thanh_hu_mon_cong_phap: getAssetUrl('items/techniques/thanh_hu_mon_cong_phap'),
        cu_kiem_mon_cong_phap: getAssetUrl('items/techniques/cu_kiem_mon_cong_phap'),
        hoa_dao_o_cong_phap: getAssetUrl('items/techniques/hoa_dao_o_cong_phap'),
        thien_khuyet_bao_cong_phap: getAssetUrl('items/techniques/thien_khuyet_bao_cong_phap'),
        thien_kiem_tong_cong_phap: getAssetUrl('items/techniques/thien_kiem_tong_cong_phap'),
        huyen_am_coc_cong_phap: getAssetUrl('items/techniques/huyen_am_coc_cong_phap'),
        yem_nguyet_tong_cong_phap: getAssetUrl('items/techniques/yem_nguyet_tong_cong_phap'),
        lac_van_tong_cong_phap: getAssetUrl('items/techniques/lac_van_tong_cong_phap'),
        quy_linh_mon_cong_phap: getAssetUrl('items/techniques/quy_linh_mon_cong_phap'),
        hop_hoan_tong_cong_phap: getAssetUrl('items/techniques/hop_hoan_tong_cong_phap'),
        ma_diem_mon_cong_phap: getAssetUrl('items/techniques/ma_diem_mon_cong_phap'),
        thien_sat_tong_cong_phap: getAssetUrl('items/techniques/thien_sat_tong_cong_phap'),
        ngu_linh_tong_cong_phap: getAssetUrl('items/techniques/ngu_linh_tong_cong_phap'),
        khoi_am_tong_cong_phap: getAssetUrl('items/techniques/khoi_am_tong_cong_phap'),
        truong_xuan_dao_kinh: getAssetUrl('items/techniques/truong_xuan_dao_kinh'),
        thai_at_kiem_quyet: getAssetUrl('items/techniques/thai_at_kiem_quyet'),
        cuu_u_ma_dien: getAssetUrl('items/techniques/cuu_u_ma_dien'),
    }, 'items/techniques', 'truong_xuan_nap_khi_quyet'),
