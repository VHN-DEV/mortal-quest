import { CONG_PHAP_QUALITIES, ELEMENT_TYPES } from './item-classification.js';
...
export const TECHNIQUES = {
    'truong_xuan_nap_khi_quyet': {
        ...
        compatibility: {
            [ELEMENT_TYPES.MOC]: 1.2,
            [ELEMENT_TYPES.THUY]: 1.1,
            [ELEMENT_TYPES.HOA]: 0.9,
            [ELEMENT_TYPES.KIM]: 0.8,
            [ELEMENT_TYPES.THO]: 1.0,
            [ELEMENT_TYPES.LOI]: 0.7,
            [ELEMENT_TYPES.PHONG]: 0.8,
            [ELEMENT_TYPES.BANG]: 0.9,
            [ELEMENT_TYPES.TAP]: 1.1
        },
        mutations: [
            { id: 'thanh_moc_truong_sinh_quyet', chance: 0.05, condition: ELEMENT_TYPES.MOC },
            { id: 'huyen_thuy_nap_linh_quyet', chance: 0.05, condition: ELEMENT_TYPES.THUY },
            { id: 'tu_duong_chan_khi', chance: 0.03, condition: ELEMENT_TYPES.HOA }
        ],
        evolution: {
    ...
    'thanh_nguyen_kiem_quyet': {
        ...
        compatibility: {
            [ELEMENT_TYPES.KIM]: 1.3,
            [ELEMENT_TYPES.MOC]: 1.3,
            'Thiên Linh Căn': 1.6
        },
        divineAbilities: {
