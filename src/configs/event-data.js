export const EVENTS = [
    {
        ...
        type: 'loot',
        description: 'Bạn vô tình phát hiện một động phủ bị bỏ hoang từ vạn năm trước.',
        result: (player) => {
            const reward = Math.floor(player.tuViPerSecond * 100);
            player.tuVi += reward;
            return `Bạn tìm thấy một ít linh đan cũ, nhận được ${reward} tu vi!`;
        }
    },
    {
        id: 'herb_discovery',
        ...
        result: (player) => {
            ...
            return 'Bạn hái được 2x Linh Thảo (Thấp)!';
        }
    },
    {
        id: 'ancient_manual',
    ...
    },
    {
        ...
        result: (player) => {
            ...
            return 'Uống một ngụm nước suối, trạng thái của bạn đã hồi phục hoàn toàn!';
        }
    },
    {
        id: 'ambush',
        ...
        type: 'combat',
        description: 'Một tên tà tu nhảy ra từ bụi rậm, ánh mắt tham lam nhìn chằm chằm vào túi đồ của bạn.'
    },
    {
        id: 'wild_beast',
        name: 'Gặp yêu thú hăng máu',
        type: 'combat',
        description: 'Tiếng gầm rú vang lên, một con yêu thú đói khát đang lao về phía bạn.'
    },
    {
