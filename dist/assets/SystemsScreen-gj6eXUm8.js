import{s as t,q as L,r as H,t as $,e as A,h as x,i as f,F as S,u as E,d as P,v as T,w as _,G as F,x as j,y as G,z as R,j as K,A as V,S as D,b as U,a as O,B as C,f as Q,P as Y,C as W,E as I,T as z,H as B,J as v,K as k,L as J,N as X,O as Z,p as q,Q as N,o as w}from"./index-DPqEJmZv.js";import"./vendor-capacitor-DNzPfH2b.js";import"./vendor-gsap-CzGW6FVa.js";const ee=[{floor:1,name:"Ngoại Tháp - Tầng 1",description:"Nơi tập trung các luyện dược sư trẻ tuổi tài năng.",minAlchemyLevel:3,rewards:{expMult:1.2}},{floor:2,name:"Nội Tháp - Tầng 2",description:"Chỉ dành cho những người có thần thức mạnh mẽ.",minAlchemyLevel:5,rewards:{expMult:1.5,qualityBonus:.1}},{floor:3,name:"Thánh Đan Điện",description:"Nơi cư ngụ của các bậc Đan Thánh.",minAlchemyLevel:7,rewards:{expMult:2,qualityBonus:.25}}];class ae{constructor(){this.shopSubFilter="all",this.shopQualityFilter="all",this.initElements(),this.initEvents()}initElements(){this.btnAlchemyTabRecipes=document.getElementById("alchemy-tab-recipes"),this.btnAlchemyTabGarden=document.getElementById("alchemy-tab-garden"),this.viewAlchemyRecipes=document.getElementById("alchemy-recipes-view"),this.viewAlchemyGarden=document.getElementById("alchemy-garden-view"),this.elAlchemyLvlText=document.getElementById("alchemy-level-text"),this.elAlchemyExpBar=document.getElementById("alchemy-exp-bar"),this.elGardenPlots=document.getElementById("garden-plots"),this.elShopLingShi=document.getElementById("shop-ling-shi"),this.elShopBuyView=document.getElementById("shop-buy-view"),this.elShopSellView=document.getElementById("shop-sell-view"),this.elShopSellGrid=document.getElementById("shop-sell-grid"),this.elShopSectionNav=document.getElementById("shop-section-nav"),this.elShopSubFilterNav=document.getElementById("shop-subfilter-nav"),this.elShopQualityFilterNav=document.getElementById("shop-quality-filter-nav"),this.elShopFiltersWrap=document.getElementById("shop-filters-wrap"),this.btnShopTabBuy=document.getElementById("shop-tab-buy"),this.btnShopTabSell=document.getElementById("shop-tab-sell"),this.elGuildCerts=document.getElementById("guild-cert-list"),this.elTechListView=document.getElementById("tech-list-view"),this.elTechDetailView=document.getElementById("tech-detail-view"),this.elTechDetailContent=document.getElementById("tech-detail-content"),this.elTechPoints=document.getElementById("tech-points"),this.btnTechTabCultivation=document.getElementById("tech-tab-cultivation"),this.btnTechTabSecret=document.getElementById("tech-tab-secret"),this.btnTechBack=document.getElementById("tech-back-btn"),this.elGuildMissions=document.getElementById("guild-mission-list"),this.elGuildRooms=document.getElementById("guild-room-list"),this.elTowerFloors=document.getElementById("tower-floor-list"),this.elSectsView=document.getElementById("sects-view")}initEvents(){this.btnAlchemyTabRecipes&&(this.btnAlchemyTabRecipes.onclick=()=>{t.views.alchemy="recipes",this.renderAlchemy()}),this.btnAlchemyTabGarden&&(this.btnAlchemyTabGarden.onclick=()=>{t.views.alchemy="garden",this.renderAlchemy()}),this.btnShopTabBuy&&(this.btnShopTabBuy.onclick=()=>{t.views.shop="buy",this.renderShop()}),this.btnShopTabSell&&(this.btnShopTabSell.onclick=()=>{t.views.shop="sell",this.renderShop()}),this.btnTechTabCultivation&&(this.btnTechTabCultivation.onclick=()=>this.renderTechniques("cultivation")),this.btnTechTabSecret&&(this.btnTechTabSecret.onclick=()=>this.renderTechniques("secret")),this.btnTechBack&&(this.btnTechBack.onclick=()=>{this.elTechListView.classList.remove("hidden"),this.elTechDetailView.classList.add("hidden")})}renderAlchemy(){if(!t.player)return;const n=document.getElementById("alchemy-tools-container");t.views.alchemy==="recipes"?(this.viewAlchemyRecipes.classList.remove("hidden"),this.viewAlchemyGarden.classList.add("hidden"),n&&n.classList.remove("hidden"),this.btnAlchemyTabRecipes&&(this.btnAlchemyTabRecipes.className="flex-grow py-3 bg-qi-blue/10 text-qi-blue border border-qi-blue/20 rounded-xl text-[10px] font-ancient uppercase tracking-widest transition-all"),this.btnAlchemyTabGarden&&(this.btnAlchemyTabGarden.className="flex-grow py-3 text-gray-500 rounded-xl text-[10px] font-ancient uppercase tracking-widest transition-all")):(this.viewAlchemyRecipes.classList.add("hidden"),this.viewAlchemyGarden.classList.remove("hidden"),n&&n.classList.add("hidden"),this.btnAlchemyTabRecipes&&(this.btnAlchemyTabRecipes.className="flex-grow py-3 text-gray-500 rounded-xl text-[10px] font-ancient uppercase tracking-widest transition-all"),this.btnAlchemyTabGarden&&(this.btnAlchemyTabGarden.className="flex-grow py-3 bg-qi-blue/10 text-qi-blue border border-qi-blue/20 rounded-xl text-[10px] font-ancient uppercase tracking-widest transition-all"));const i=L(t.player.alchemyLevel);this.elAlchemyLvlText.textContent=i.name;const s=t.player.alchemyLevel*100*Math.pow(1.5,t.player.alchemyLevel-1);this.elAlchemyExpBar.style.width=`${t.player.alchemyExp/s*100}%`,t.views.alchemy==="recipes"?this.renderRecipes():this.renderGarden();const e=document.getElementById("alchemy-cauldron-name"),o=document.getElementById("alchemy-flame-name");if(e){const a=H(t.player.currentCauldron);a?e.innerHTML=`<span class="text-white">${a.name}</span>`:e.innerHTML=`<span class="text-gray-500 italic">Chưa có</span> <button onclick="window.game.openShop('buy', 'van_bao_cac', 'phap_bao')" class="ml-2 text-[8px] text-qi-blue underline hover:text-white transition-colors">MUA NGAY</button>`}if(o){const a=$(t.player.currentFlame);a?o.innerHTML=`<span class="text-white">${a.name}</span>`:o.innerHTML=`<span class="text-gray-500 italic">Chưa có</span> <button onclick="window.game.openShop('buy', 'van_bao_cac', 'phap_bao')" class="ml-2 text-[8px] text-qi-blue underline hover:text-white transition-colors">MUA NGAY</button>`}}renderRecipes(){this.viewAlchemyRecipes.innerHTML="";const n=A.filter(i=>t.player.knownRecipes.includes(i.id));if(n.length===0){this.viewAlchemyRecipes.innerHTML='<div class="text-center py-10 text-gray-600 italic text-xs">Ngươi chưa lĩnh ngộ được đan phương nào...</div>';return}n.forEach(i=>{const s=x(i.resultId);if(!s)return;const e=this.getQualityClass(s.quality),o=document.createElement("div");o.className="p-4 border border-gray-800 rounded-2xl bg-white/5 space-y-3";let a="";i.materials.forEach(r=>{const c=x(r.id);if(!c)return;const h=t.player.inventory.allItems.find(d=>d.id===r.id),p=h?h.quantity:0,m=p>=r.quantity;a+=`<div class="text-[10px] ${m?"text-gray-400":"text-red-500"}">${c.name}: ${p}/${r.quantity}</div>`});const l=t.player.alchemyLevel<i.level;o.innerHTML=`
        ...
        `;const e=this.elShopSubFilterNav.querySelector("#shop-subfilter-select");e.onchange=l=>{this.shopSubFilter=l.target.value,this.renderShop()}}renderShopQualityFilters(){if(!this.elShopQualityFilterNav)return;const n=t.systems.shop;if(!n)return;if(!(n.currentSection==="phap_bao")){this.elShopQualityFilterNav.classList.add("hidden"),this.elShopSubFilterNav.classList.remove("border-r","border-white/5"),this.elShopQualityFilterNav.innerHTML="";return}this.elShopSubFilterNav.classList.add("border-r","border-white/5");const e=[{id:"all",name:"Tất cả phẩm"},{id:"Phàm Khí",name:"Phàm Khí"},{id:"Pháp Khí",name:"Pháp Khí"},{id:"Linh Khí",name:"Linh Khí"},{id:"Pháp Bảo",name:"Pháp Bảo"},{id:"Cổ Bảo",name:"Cổ Bảo"},{id:"Linh Bảo",name:"Linh Bảo"},{id:"Thông Thiên Linh Bảo",name:"Thông Thiên Linh Bảo"},{id:"Tiên Khí",name:"Tiên Khí"},{id:"Danh Khí",name:"Danh Khí"}];this.elShopQualityFilterNav.classList.remove("hidden"),this.elShopQualityFilterNav.className="p-2 flex-1 border-white/5",this.elShopQualityFilterNav.innerHTML=`
            <select id="shop-quality-select" class="w-full bg-black/40 text-cultivation-gold border border-cultivation-gold/20 rounded-lg px-2 py-1.5 text-[9px] font-ancient uppercase tracking-widest outline-none transition-all focus:border-cultivation-gold/50">
                ${e.map(a=>`<option value="${a.id}" ${this.shopQualityFilter===a.id?"selected":""}>${a.name}</option>`).join("")}
            </select>
        `;const o=this.elShopQualityFilterNav.querySelector("#shop-quality-select");o.onchange=a=>{this.shopQualityFilter=a.target.value,this.renderShop()}}renderShopBuy(){const n=t.systems.shop;let i=n.getShopInventory();if(n.currentSection==="cong_phap"){const s=T[n.currentShopId];s.sections.bi_tich&&(i=[...i,...s.sections.bi_tich])}this.elShopBuyView.innerHTML="",i.forEach(s=>{var d;const e=x(s.id);if(!e)return;if(this.shopSubFilter!=="all"){if(n.currentSection==="phap_bao"){if(e.type!==this.shopSubFilter)return}else if(n.currentSection==="cong_phap"){const u=e.action&&(e.action.startsWith("open_")||e.action.includes("linh_the_luc")||((d=e.effect)==null?void 0:d.type)==="unlock_profession"),y=(e.type==="book"||e.type==="technique")&&!u,b=e.type==="recipe"||e.type==="talisman_recipe"||u;if(this.shopSubFilter==="cultivation"&&!y||this.shopSubFilter==="manual"&&!b)return}}if(this.shopQualityFilter!=="all"&&e.quality!==this.shopQualityFilter)return;const o=this.getQualityClass(e.quality),a=document.createElement("div");a.className=`flex items-center justify-between p-3 bg-black/40 border border-gray-800 rounded-xl hover:border-${o} cursor-pointer transition-colors duration-200`,a.onclick=()=>{window.game.screens.inventory&&window.game.screens.inventory.selectItem(s.id,!0)};const l=document.createElement("div");l.className="flex items-center space-x-3",l.innerHTML=`
                <div class="text-2xl bg-black/60 p-2 rounded-lg border border-${o}/30">${e.image?`<img src="${f(e.image)}" class="w-8 h-8 object-contain">`:e.icon||""}</div>
                <div>
                    <div class="text-sm font-bold text-white">${e.name}</div>
                    <div class="text-[9px] font-bold quality-${o}">${e.quality}${e.quality.toLowerCase().includes("khí")||e.quality.toLowerCase().includes("bảo")||e.quality.toLowerCase().includes("phẩm")||e.quality.toLowerCase().includes("giai")||e.quality.toLowerCase().includes("hỏa")||e.quality.toLowerCase().includes("lôi")||["Hoàn Mỹ","Tiên Khí","Linh Bảo","Danh Khí"].includes(e.quality)?"":" phẩm"} | Kho: ${s.stock}</div>
                </div>
            `;const r=Math.floor(e.price*(1-Math.min(.25,t.player.vipLevel*.05))),c=s.minVip&&t.player.vipLevel<s.minVip,h=document.createElement("div");h.className="flex items-center space-x-3",h.innerHTML=`
            ...
            `;const p=document.createElement("button"),m=s.stock<=0;p.className=`px-3 py-1.5 btn-gold text-[10px] font-bold rounded-lg whitespace-nowrap ${m||c?"opacity-50 grayscale pointer-events-none":""}`,p.innerHTML='<i class="ph ph-shopping-cart-simple mr-1"></i>TRAO ĐỔI',p.onclick=u=>{u.stopPropagation(),window.game.buyItem(s.id)},h.appendChild(p),a.appendChild(l),a.appendChild(h),this.elShopBuyView.appendChild(a)})}renderShopSell(){if(this.elShopSellGrid.innerHTML="",!t.player||!t.player.inventory)return;const n=t.systems.shop.currentSection,i=this.shopSubFilter;t.player.inventory.allItems.forEach(s=>{var c;const e=x(s.id);if(!e)return;const o={dan_duoc:["consumable"],phap_bao:["weapon","armor","accessory","treasure","head","necklace","shoes","attackArtifact","defenseArtifact","flightArtifact","spaceArtifact","formationArtifact","supportArtifact","soulArtifact"],nguyen_lieu:["material","herb","ore","wood"],cong_phap:["book","technique","recipe","talisman_recipe","consumable"],tran_phap:["formation"],phu_luc:["talisman"],luyen_khi:["material","smithing_tool"],tui_tru_vat:["consumable"]};if(n&&o[n]){if(!o[n].includes(e.type))return;if(n==="cong_phap"){const h=e.action&&(e.action.startsWith("open_")||e.action.includes("linh_the_luc")),p=(e.type==="book"||e.type==="technique")&&!h,m=e.type==="recipe"||e.type==="talisman_recipe"||e.type==="consumable"&&((c=e.effect)==null?void 0:c.type)==="unlock_profession"||h;if(i==="cultivation"&&!p||i==="manual"&&p||i==="manual"&&!m&&!p||i==="all"&&!p&&!m)return}if(n==="phap_bao"&&i!=="all"&&e.type!==i||n==="tui_tru_vat"&&e.action!=="expand_inventory"||this.shopQualityFilter!=="all"&&e.quality!==this.shopQualityFilter)return}const a=this.getQualityClass(e.quality);let l=.5;["material","herb","ore","wood"].includes(e.type)&&(l=.3);const r=document.createElement("div");r.className=`p-2 border border-gray-800 rounded-lg bg-black/20 flex flex-col items-center cursor-pointer hover:border-${a} transition-colors duration-200 active:scale-95`,r.innerHTML=`
                <div class="text-2xl mb-1">${e.image?`<img src="${f(e.image)}" class="w-8 h-8 object-contain">`:e.icon||""}</div>
                <div class="text-[9px] text-gray-400">x${s.quantity}</div>
                <div class="text-[8px] text-cultivation-gold mt-1">${Math.floor(e.price*l)} LT</div>
            `,r.onclick=()=>{window.game.screens.inventory&&window.game.screens.inventory.selectItem(s.id,!1,!0)},this.elShopSellGrid.appendChild(r)})}renderGuild(){t.player&&(this.elGuildCerts.innerHTML="",this.elGuildMissions=document.getElementById("guild-mission-list"),this.elGuildRooms=document.getElementById("guild-room-list"),_.forEach(n=>{var e;const i=t.player.alchemyLevel<n.requirements.alchemyLevel,s=document.createElement("div");s.className="p-4 border border-white/5 rounded-xl bg-white/5 flex justify-between items-center",s.innerHTML=`
                <div>
            ...
            `,this.elGuildCerts.appendChild(s)}),this.elGuildMissions&&(this.elGuildMissions.innerHTML="",F.forEach(n=>{const i=document.createElement("div");i.className="p-4 border border-white/5 rounded-xl bg-white/5 space-y-2",i.innerHTML=`
                ...
                `,this.elGuildMissions.appendChild(i)})),this.elGuildRooms&&(this.elGuildRooms.innerHTML="",j.forEach(n=>{const i=t.player.currentAlchemyRoom===n.id,s=document.createElement("div");s.className=`p-4 border border-white/5 rounded-xl bg-white/5 flex justify-between items-center ${i?"border-cultivation-gold":""}`,s.innerHTML=`
                    <div>
            ...
            `,s||(e.onclick=()=>t.ui.toast(`Đang tiến vào ${i.name}...`,"success")),n.appendChild(e)}))}renderMountain(){const n=document.getElementById("mountain-layer-name"),i=document.getElementById("mountain-layer-desc"),s=document.getElementById("mountain-layer-progress-text"),e=document.getElementById("mountain-layer-progress-bar"),o=document.getElementById("mountain-oxygen-text"),a=document.getElementById("mountain-oxygen-bar"),l=document.getElementById("mountain-toxicity-text"),r=document.getElementById("mountain-toxicity-bar");if(document.getElementById("mountain-event-log"),!t.player.mountainSurvival)return;const c=t.systems.mountain,h=G.find(u=>u.id===c.currentLayer),p=R.find(u=>u.id===h.tier);if(n){const u={ngoai_son:"text-green-400",trung_son:"text-blue-400",noi_son:"text-purple-400",cam_khu:"text-red-500"}[h.tier]||"text-red-400";n.innerHTML=`<span class="text-[10px] block opacity-60 uppercase tracking-tighter">${p.name}</span>${h.name}`,n.className=`text-2xl font-ancient ${u} mb-1`}i&&(i.textContent=h.description);const m=c.discovery[c.currentLayer]||0;s&&(s.textContent=`${Math.floor(c.layerProgress)}% (Khám phá: ${Math.floor(m)}%)`),e&&(e.style.width=`${c.layerProgress}%`),o&&(o.textContent=`${Math.ceil(t.player.mountainSurvival.oxygen)}%`),a&&(a.style.width=`${t.player.mountainSurvival.oxygen}%`),l&&(l.textContent=`${Math.ceil(t.player.mountainSurvival.toxicity)}%`),r&&(r.style.width=`${t.player.mountainSurvival.toxicity}%`);const d=document.getElementById("btn-mountain-deeper");if(d){const u=c.bossDefeated[h.tier];c.layerProgress>=100&&!u?d.innerHTML='<span class="relative z-10 text-xs font-bold text-red-500 uppercase tracking-[0.2em] animate-pulse">KHIÊU CHIẾN THỦ LĨNH</span>':d.innerHTML='<span class="relative z-10 text-xs font-bold text-red-400 uppercase tracking-[0.2em]">TẦNG KẾ TIẾP</span>'}t.player.hp<=0&&(t.systems.mountain.stop(),t.ui.toggleOverlay(document.getElementById("mountain-overlay"),!1))}renderSects(){const n=document.getElementById("sects-view");if(n)if(n.innerHTML="",t.player.sectId){const i=K(t.player.sectId);n.innerHTML=`
                <div class="bg-white/5 rounded-2xl border border-qi-blue/30 overflow-hidden">
                    <div class="h-32 relative">
                        <img src="${i.portrait||V.backgrounds.sect}" class="w-full h-full object-cover opacity-40">
            ...
            `}else Object.values(D).forEach(i=>{const s=t.player.realmId>=i.minRealm,e=document.createElement("div");e.className=`p-4 border rounded-xl bg-black/40 space-y-3 ${s?"border-gray-800":"opacity-50 grayscale"}`,e.innerHTML=`
                    <div class="flex justify-between items-center">
                ...
                `,n.appendChild(e)})}renderEnergy(){if(!t.player)return;const n=document.getElementById("env-energy-list"),i=document.getElementById("env-purity-tag");if(n&&t.currentLocId){const e=O(t.currentWorldId,t.currentLocId);if(e&&e.energies){if(i&&e.energies.length>0){const o=e.energies[0].purity||"TINH_THUAN",a=t.systems.energy.getPurity(o);i.textContent=a.name}n.innerHTML=e.energies.map(o=>{const a=t.systems.energy.getEnergyType(o.type);return`
                    ...
                    `}).join("")}else n.innerHTML=""}const s=document.getElementById("char-energy-list");if(s){const e=Object.entries(t.player.qiAccumulated).filter(([o,a])=>a.amount>0);e.length===0?s.innerHTML='<div class="text-[9px] text-gray-600 italic">Chưa có khí tức tích lũy</div>':s.innerHTML=e.map(([o,a])=>{const l=t.systems.energy.getEnergyType(o),r=t.systems.energy.getPurity(a.purity),c=Math.log10(a.amount+1);return`
                    ...
                    `}).join("")}}getQualityClass(n){return{"Phàm Khí":"pham-khi","Pháp Khí":"phap-khi","Linh Khí":"linh-khi","Pháp Bảo":"phap-bao","Cổ Bảo":"co-bao","Linh Bảo":"linh-bao","Thông Thiên Linh Bảo":"thong-thien","Tiên Khí":"tien-khi","Danh Khí":"danh-khi","Hạ phẩm":"pham","Trung phẩm":"hoang","Thượng phẩm":"huyen","Cực phẩm":"dia","Hoàn Mỹ":"thien"}[n]||"pham"}renderSmithing(){const n=document.getElementById("smithing-recipes");if(!n)return;n.innerHTML="";const i=document.getElementById("smithing-tool-name"),s=document.getElementById("smithing-flame-name");if(i){const l=t.player.smithingTool?x(t.player.smithingTool):null;l?i.innerHTML=`<span class="text-white">${l.name}</span>`:i.innerHTML=`<span class="text-gray-500 italic">Chưa có</span> <button onclick="window.game.openShop('buy', 'van_bao_cac', 'luyen_khi')" class="ml-2 text-[8px] text-red-400 underline hover:text-white transition-colors">MUA NGAY</button>`}if(s){const l=$(t.player.currentFlame);l?s.innerHTML=`<span class="text-white">${l.name}</span>`:s.innerHTML=`<span class="text-gray-500 italic">Chưa có</span> <button onclick="window.game.openShop('buy', 'van_bao_cac', 'phap_bao')" class="ml-2 text-[8px] text-red-400 underline hover:text-white transition-colors">MUA NGAY</button>`}const e=C(t.player.smithingLevel),o=document.getElementById("smithing-level-text");o&&(o.textContent=e.name);const a=Object.values(Q).filter(l=>t.player.knownSmithingRecipes.includes(l.id));if(a.length===0){n.innerHTML='<div class="text-center py-10 text-gray-600 italic text-xs">Ngươi chưa lĩnh ngộ được bản vẽ nào...</div>';return}a.forEach(l=>{const r=x(l.id);if(!r)return;const c=this.getQualityClass(r.quality),h=document.createElement("div");h.className="p-4 border border-gray-800 rounded-2xl bg-white/5 space-y-3";let p="";l.materials.forEach(d=>{var g;const u=x(d.id),y=((g=t.player.inventory.allItems.find(M=>M.id===d.id))==null?void 0:g.quantity)||0,b=y>=d.quantity;p+=`<div class="text-[10px] ${b?"text-gray-400":"text-red-500"}">${(u==null?void 0:u.name)||d.id}: ${y}/${d.quantity}</div>`});const m=t.player.smithingLevel<l.level;h.innerHTML=`
                <div class="flex justify-between items-center">
                    <div class="flex items-center">
                    ...
                    ${m?`<span class="text-[8px] text-red-500 uppercase font-ancient">Cần Cấp ${l.level}</span>`:`<button class="px-4 py-2 btn-gold text-[10px] font-bold rounded-lg whitespace-nowrap" onclick="window.game.forge('${l.id}')">${l.type==="bag_upgrade"?"NÂNG CẤP":"RÈN ĐÚC"}</button>`}
                </div>
            ...
            `,n.appendChild(h)})}openCrafting(n){if(!t.player)return;if(!t.player.unlockedProfessions.includes(n)){t.ui.toast("Ngươi chưa nắm vững bí pháp của nghề này!","error");return}const e={alchemy:"screen-alchemy",smithing:"screen-smithing",talisman:"screen-talisman",formation:"screen-formation",beast:"screen-beast",puppet:"screen-puppet",corpse:"screen-corpse"}[n];e&&(t.ui.switchScreen(e),n==="alchemy"&&this.renderAlchemy(),n==="smithing"&&this.renderSmithing(),n==="talisman"&&this.renderTalisman(),n==="formation"&&this.renderFormation(),n==="beast"&&this.renderBeast(),n==="puppet"&&this.renderPuppet(),n==="corpse"&&this.renderCorpse())}openCraftingHub(){["screen-alchemy","screen-talisman","screen-smithing","screen-formation","screen-corpse","screen-beast","screen-puppet"].forEach(s=>{const e=document.getElementById(s);e&&(e.classList.add("hidden"),e.classList.remove("flex"))});const i=document.getElementById("screen-crafting-hub");i&&(i.classList.remove("hidden"),i.classList.add("flex"))}renderPuppet(){if(!t.player)return;const n=document.getElementById("puppet-level-text"),i=document.getElementById("puppet-exp-bar"),s=document.getElementById("puppet-list");if(n&&(n.textContent=`Khôi Lỗi Sư - Cấp ${t.player.puppetLevel}`),i){const e=t.player.puppetLevel*100*Math.pow(1.5,t.player.puppetLevel-1);i.style.width=`${t.player.puppetExp/e*100}%`}if(s){s.innerHTML="";const e=Y.filter(o=>t.player.knownPuppetRecipes.includes(o.id));if(e.length===0){s.innerHTML='<div class="text-center py-10 text-gray-600 italic text-xs">Ngươi chưa có bản thiết kế khôi lỗi nào...</div>';return}e.forEach(o=>{const a=document.createElement("div");a.className="p-5 border border-white/5 rounded-3xl bg-white/[0.02] space-y-4 group hover:border-qi-blue/30 transition-all";let l="";o.materials.forEach(c=>{var d;const h=x(c.id),p=((d=t.player.inventory.allItems.find(u=>u.id===c.id))==null?void 0:d.quantity)||0,m=p>=c.quantity;l+=`
                        <div class="flex justify-between items-center bg-black/20 p-2 rounded-xl border ${m?"border-white/5":"border-red-500/20"}">
                            <span class="text-[10px] text-gray-400">${(h==null?void 0:h.name)||c.id}</span>
                            <span class="text-[10px] font-mono ${m?"text-qi-jade":"text-red-500"}">${p}/${c.quantity}</span>
                        </div>
                    `});const r=t.player.puppetLevel<o.skillLevel;a.innerHTML=`
                    <div class="flex justify-between items-start">
                ...
                `,s.appendChild(a)})}}renderTalisman(){if(!t.player)return;const n=I(t.player.talismanLevel),i=document.getElementById("talisman-level-text"),s=document.getElementById("talisman-exp-bar"),e=document.getElementById("talisman-recipes");if(i&&(i.textContent=n.name),s){const a=t.player.talismanLevel*100*Math.pow(1.5,t.player.talismanLevel-1);s.style.width=`${t.player.talismanExp/a*100}%`}const o=document.getElementById("current-pen-name");if(o){const a=t.player.currentTalismanPen?x(t.player.currentTalismanPen):null;a?o.innerHTML=`<span class="text-white">${a.name}</span>`:o.innerHTML=`<span class="text-gray-500 italic">Chưa có</span> <button onclick="window.game.openShop('buy', 'van_bao_cac', 'phu_luc')" class="ml-2 text-[8px] text-qi-blue underline hover:text-white transition-colors">MUA NGAY</button>`}if(e){e.innerHTML="";const a=Object.values(z).filter(l=>t.player.knownTalismanRecipes.includes(l.id));if(a.length===0){e.innerHTML='<div class="text-center py-10 text-gray-600 italic text-xs">Ngươi chưa lĩnh ngộ được phù văn nào...</div>';return}a.forEach(l=>{const r=document.createElement("div");r.className="p-4 border border-white/5 rounded-2xl bg-white/[0.02] mb-3";let c="";l.materials.forEach(p=>{var u;const m=x(p.id),d=((u=t.player.inventory.allItems.find(y=>y.id===p.id))==null?void 0:u.quantity)||0;c+=`<div class="text-[9px] ${d>=p.quantity?"text-gray-400":"text-red-500"}">${m.name} x${p.quantity} (${d})</div>`});const h=t.player.talismanLevel<l.level;r.innerHTML=`
                ...
                `,e.appendChild(r)})}}renderBeast(){if(!t.player)return;const n=document.getElementById("beast-list-view"),i=document.getElementById("beast-hatch-view"),s=document.getElementById("beast-tab-beast"),e=document.getElementById("beast-tab-insect"),o=document.getElementById("beast-tab-hatch");t.views.beast||(t.views.beast="beast"),t.views.beast==="hatch"?(n&&n.classList.add("hidden"),i&&i.classList.remove("hidden")):(n&&n.classList.remove("hidden"),i&&i.classList.add("hidden"));const a=["bg-qi-jade/10","text-qi-jade","border-qi-jade/20"],l=["bg-transparent","text-gray-500","border-transparent"];[s,e,o].forEach(m=>{if(m){m.classList.remove(...a,...l);const d=m===s&&t.views.beast==="beast"||m===e&&t.views.beast==="insect"||m===o&&t.views.beast==="hatch";m.classList.add(...d?a:l)}});const r=document.getElementById("beast-level-text"),c=document.getElementById("beast-exp-bar"),h=t.views.beast==="insect"?t.player.insectLevel:t.player.beastLevel,p=t.views.beast==="insect"?t.player.insectExp:t.player.beastExp;if(r&&(r.textContent=`Cấp ${h}`),c){const m=h*100*Math.pow(1.5,h-1);c.style.width=`${p/m*100}%`}if(n&&t.views.beast!=="hatch"){n.innerHTML="";const m=t.player.beasts.filter(d=>{const u=B[d.id];return u?t.views.beast==="beast"?[v.LINH_THU,v.DI_THU,v.THAN_THU].includes(u.type):t.views.beast==="insect"?[v.LINH_TRUNG,v.KY_TRUNG].includes(u.type):!0:!1});if(m.length===0){const d=t.views.beast==="beast"?"linh thú":"kỳ trùng";n.innerHTML=`<div class="text-center py-10 text-gray-600 italic">Ngươi chưa có ${d} nào...</div>`}else m.forEach(d=>{const u=B[d.id],y=k(d.level),b=J[d.bloodline],g=document.createElement("div");g.className="p-4 border border-white/5 rounded-2xl bg-white/[0.02] flex items-center space-x-4",g.innerHTML=`
                        <div class="text-4xl">${(u==null?void 0:u.icon)||"🐾"}</div>
                        <div class="flex-grow">
                            <div class="flex justify-between items-center">
                    ...
                    `,n.appendChild(g)})}if(i&&t.views.beast==="hatch"){i.innerHTML="";const m=t.player.inventory.allItems.filter(d=>x(d.id).type==="beast_egg");m.length===0?i.innerHTML='<div class="text-center py-10 text-gray-600 italic">Ngươi không có trứng linh thú nào...</div>':m.forEach(d=>{const u=x(d.id),y=document.createElement("div");y.className="p-4 border border-white/5 rounded-2xl bg-white/[0.02] flex justify-between items-center",y.innerHTML=`
                        <div class="flex items-center space-x-3">
                    ...
                    `,i.appendChild(y)})}s&&(s.onclick=()=>{t.views.beast="beast",this.renderBeast()}),e&&(e.onclick=()=>{t.views.beast="insect",this.renderBeast()}),o&&(o.onclick=()=>{t.views.beast="hatch",this.renderBeast()})}renderCraftingHub(){if(!t.player)return;[{id:"alchemy",key:"alchemy",name:"Luyện Dược Sư",level:t.player.alchemyLevel,exp:t.player.alchemyExp,getLevelInfo:L},{id:"talisman",key:"talisman",name:"Phù Sư",level:t.player.talismanLevel,exp:t.player.talismanExp,getLevelInfo:I},{id:"smithing",key:"smithing",name:"Luyện Khí Sư",level:t.player.smithingLevel,exp:t.player.smithingExp,getLevelInfo:C},{id:"formation",key:"formation",name:"Trận Pháp Sư",level:t.player.formationLevel,exp:t.player.formationExp,getLevelInfo:i=>({name:`Cấp ${i}`})},{id:"puppet",key:"puppet",name:"Khôi Lỗi Sư",level:t.player.puppetLevel,exp:t.player.puppetExp,getLevelInfo:i=>({name:`Cấp ${i}`})},{id:"corpse",key:"corpse",name:"Luyện Thi Sư",level:t.player.corpseLevel,exp:t.player.corpseExp,getLevelInfo:i=>({name:`Cấp ${i}`})},{id:"beast",key:"beast",name:"Ngự Thú Sư",level:t.player.beastLevel,exp:t.player.beastExp,getLevelInfo:k},{id:"insect",key:"insect",name:"Khu Trùng Sư",level:t.player.insectLevel,exp:t.player.insectExp,getLevelInfo:i=>({name:`Cấp ${i}`})}].forEach(i=>{const s=document.getElementById(`hub-${i.id}-level`),e=s==null?void 0:s.closest(".hub-card");if(!s||!e)return;const o=t.player.unlockedProfessions.includes(i.id);e.onclick=()=>window.game.openCrafting(i.id);const a={alchemy:"Đan Đạo Chân Giải",talisman:"Thái Thượng Phù Kinh",smithing:"Luyện Khí Tổng Cương",formation:"Trận Đạo Thiên Thư",puppet:"Cơ Quan Linh Kỹ",corpse:"Cửu U Luyện Thi Thuật",beast:"Vạn Thú Ngự Pháp",insect:"Thiên Trùng Bí Lục"};if(o){const l=i.getLevelInfo?i.getLevelInfo(i.level):{name:`Cấp ${i.level}`},r=i.level*100*Math.pow(1.5,i.level-1),c=Math.floor(i.exp/r*100);s.innerHTML=`${i.name} - ${l.name} <span class="text-white/30 ml-2">(${c}%)</span>`,e.classList.remove("opacity-40","grayscale"),e.classList.add("cursor-pointer")}else s.innerHTML=`
                ...
                `,e.classList.add("opacity-40","grayscale"),e.classList.remove("cursor-pointer")})}renderFormation(){if(!t.player)return;const n=document.getElementById("formation-list");if(!n)return;if(n.innerHTML="",t.player.activeFormations.length>0){const e=document.createElement("h3");e.className="text-[10px] text-gray-500 uppercase tracking-widest mb-2",e.textContent="Trận Pháp Đang Hoạt Động",n.appendChild(e),t.player.activeFormations.forEach(o=>{const a=document.createElement("div");a.className="p-4 border border-qi-purple/30 rounded-2xl bg-qi-purple/5 mb-4 flex justify-between items-center",a.innerHTML=`
                    <div>
                ...
                `,n.appendChild(a)})}const i=t.player.knownFormations||[],s=document.createElement("h3");if(s.className="text-[10px] text-gray-500 uppercase tracking-widest mt-6 mb-2",s.textContent="Trận Đồ Đã Lĩnh Ngộ",n.appendChild(s),i.length===0){const e=document.createElement("div");e.className="text-center py-6 text-gray-700 italic text-xs",e.textContent="Trống rỗng...",n.appendChild(e)}else i.forEach(e=>{const o=x(e);if(!o)return;const a=t.player.activeFormations.some(r=>r.id===e),l=document.createElement("div");l.className="p-4 border border-white/5 rounded-2xl bg-white/[0.02] mb-3 flex justify-between items-center",l.innerHTML=`
                    <div class="flex items-center space-x-3">
                    ...
                    ${a?'<span class="text-[9px] text-qi-purple font-bold">ĐÃ KÍCH HOẠT</span>':`<button class="px-4 py-2 bg-qi-purple/10 text-qi-purple text-[10px] rounded-xl border border-qi-purple/20" onclick="window.game.activateFormation('${e}')">KÍCH HOẠT</button>`}
                `,n.appendChild(l)})}renderCorpse(){if(!t.player)return;const n=document.getElementById("corpse-list"),i=document.getElementById("corpse-level-text"),s=document.getElementById("corpse-exp-bar");if(i&&(i.textContent=X(t.player.corpseLevel).name),s){const a=t.player.corpseLevel*100*Math.pow(1.5,t.player.corpseLevel-1);s.style.width=`${t.player.corpseExp/a*100}%`}if(!n)return;if(n.innerHTML="",t.player.refinedCorpses.length>0){const a=document.createElement("h3");a.className="text-[10px] text-gray-500 uppercase tracking-widest mb-3 border-b border-white/5 pb-1",a.textContent="Thi Hài Đang Khống Chế",n.appendChild(a),t.player.refinedCorpses.forEach((l,r)=>{const c=document.createElement("div");c.className="p-4 border border-red-900/30 rounded-2xl bg-red-900/5 mb-4 flex items-center space-x-4",c.innerHTML=`
                ...
                `,n.appendChild(c)})}const e=document.createElement("h3");e.className="text-[10px] text-gray-500 uppercase tracking-widest mt-6 mb-3 border-b border-white/5 pb-1",e.textContent="Bản Vẽ Luyện Thi",n.appendChild(e);const o=Object.values(Z).filter(a=>t.player.knownCorpseRecipes.includes(a.id));if(o.length===0){const a=document.createElement("div");a.className="text-center py-6 text-gray-700 italic text-xs",a.textContent="Ngươi chưa có bí phương luyện thi nào...",n.appendChild(a)}else o.forEach(a=>{const l=document.createElement("div");l.className="p-4 border border-white/5 rounded-2xl bg-white/[0.02] mb-3 space-y-3";let r="";a.materials.forEach(p=>{var u;const m=x(p.id),d=((u=t.player.inventory.allItems.find(y=>y.id===p.id))==null?void 0:u.quantity)||0;r+=`<div class="text-[9px] ${d>=p.quantity?"text-gray-400":"text-red-500"}">${(m==null?void 0:m.name)||p.id} x${p.quantity} (${d})</div>`});const c=t.player.corpseLevel<a.level,h=Math.floor((.7-a.level*.1+t.player.corpseLevel*.05)*100);l.innerHTML=`
                <div class="flex justify-between items-start">
                    <div>
            ...
            `,n.appendChild(l)})}renderTechniques(n="cultivation"){if(t.player){if(t.activeTechTab=n,this.btnTechTabCultivation&&this.btnTechTabSecret&&(n==="cultivation"?(this.btnTechTabCultivation.className="flex-grow py-2 bg-qi-blue/20 text-qi-blue border border-qi-blue/30 rounded-xl text-[10px] font-ancient uppercase tracking-widest transition-all",this.btnTechTabSecret.className="flex-grow py-2 text-gray-500 rounded-xl text-[10px] font-ancient uppercase tracking-widest transition-all"):(this.btnTechTabCultivation.className="flex-grow py-2 text-gray-500 rounded-xl text-[10px] font-ancient uppercase tracking-widest transition-all",this.btnTechTabSecret.className="flex-grow py-2 bg-qi-purple/20 text-qi-purple border border-qi-purple/30 rounded-xl text-[10px] font-ancient uppercase tracking-widest transition-all")),this.elTechListView){this.elTechListView.innerHTML="",this.elTechListView.classList.remove("hidden"),this.elTechDetailView&&this.elTechDetailView.classList.add("hidden");const i=n==="cultivation"?t.player.learnedTechniques:t.player.learnedSecretTechniques;i.length===0?this.elTechListView.innerHTML=`<div class="text-center py-20 text-gray-600 italic text-xs">Ngươi chưa lĩnh ngộ ${n==="cultivation"?"công pháp":"bí pháp"} nào...</div>`:i.forEach(s=>{const e=n==="cultivation"?q(s.id):N(s.id);if(!e)return;const o=w.find(c=>c.id===(s.masteryLevel||1)),a=e.stageLabel||"Tầng",l=e.stageNames&&e.stageNames[s.stage-1]?e.stageNames[s.stage-1]:`${a} ${s.stage||1}`,r=document.createElement("div");r.className=`p-4 border ${n==="cultivation"?"border-qi-blue/10 bg-qi-blue/5":"border-qi-purple/10 bg-qi-purple/5"} rounded-2xl flex items-center justify-between hover:bg-white/5 cursor-pointer transition-all mb-3`,r.innerHTML=`
                    ...
                    `,r.onclick=()=>this.renderTechniqueDetail(s.id,n==="secret"),this.elTechListView.appendChild(r)})}this.elTechPoints&&(this.elTechPoints.textContent=t.player.techniquePoints||0)}}renderTechniqueDetail(n,i){if(!this.elTechDetailContent)return;const s=i?t.player.learnedSecretTechniques.find(p=>p.id===n):t.player.learnedTechniques.find(p=>p.id===n),e=i?N(n):q(n);if(!s||!e)return;this.elTechListView.classList.add("hidden"),this.elTechDetailView.classList.remove("hidden");const o=w.findIndex(p=>p.id===(s.masteryLevel||1)),a=w[o],l=w[o+1],r=e.stageLabel||"Tầng",c=e.stageNames&&e.stageNames[s.stage-1]?e.stageNames[s.stage-1]:`${r} ${s.stage||1}`,h=s.masteryLevel>=4&&s.stage<(e.maxStage||10);this.elTechDetailContent.innerHTML=`
